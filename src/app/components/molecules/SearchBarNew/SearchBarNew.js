...
const Spinner = () => {
    return (
        <div role="status">
            <svg aria-hidden="true" className="w-[1em] h-[1em] text-color-primary animate-spin fill-zinc-100 dark:fill-zinc-800" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
